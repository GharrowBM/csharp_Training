...
namespace HeritageSalarie.Views
{
    internal class IHM
    {
        ...
        {
            salaries = new Employee[nbSalarie];
        }
        ...
        private void ActionAjouterSalarie()
        {
            ...
            if (type == "1")
            {
                s = new Employee(matricule, categorie, salaire, service, nom);
        ...
        private void ActionAfficherSalaries()
        {
            ...
            foreach (Employee salarie in salaries)
            {
                if (salarie != default(Employee))
        ...
        private void ActionRechercheSalarie()
        {
            ...
            string nom = Console.ReadLine();
            bool found = false;
            foreach (Employee s in salaries)
            {
                if (s != default(Employee))
                {
                    if (s.Nom == nom)
                    {
                        found = true;
